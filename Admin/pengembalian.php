                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            FROM pesanan INNER JOIN user ON pesanan.idUser = user.id INNER JOIN sewa ON sewa.idUser = user.id WHERE pesanan.status = 'diambil'
        ...
        <div class="modal-content">
            ...
            <form action="proses.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="kembali">Konfirmasi Pengambilan</button>
                </div>
            </form>
        </div>
    </div>
