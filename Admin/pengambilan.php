                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            FROM pesanan INNER JOIN user ON pesanan.idUser = user.id INNER JOIN sewa ON sewa.idUser = user.id WHERE pesanan.status = 'pending'
                            ...
                            while ($result = mysqli_fetch_array($query)) {
                                ...
                                $tgl_kembali = $result['lama_sewa_start'];
                                ...
                                <tr>
                                    ...
                                    <td scope="row">
                                        ...
                                        <form action="proses.php" method="post">
                                            ...
                                            <button type="submit" class="btn btn-danger" name="hapuspsn" onclick="return confirm('Are you sure you want to delete this item?')">Hapus</button>
                                        </form>
                                    </td>
                                </tr>
                            <?php
        ...
        <div class="modal-content">
            ...
            <form action="proses.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                <div class="modal-body">
                    ...
                    <!-- Hidden input field to pass the 'idPesanan' value to proses.php -->
                    <input type="hidden" name="idPesanan" value="<?php echo $idPesanan; ?>">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                    <!-- Add type="submit" to the button -->
                    <button type="submit" class="btn btn-primary" name="ambil">Konfirmasi Pesanan</button>
                </div>
            </form>
        </div>
    </div>
